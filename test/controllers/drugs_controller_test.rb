...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { atc: @drug.atc, drugbank: @drug.drugbank, name: @drug.name, reference: @drug.reference }
    end
  ...
  test "should update drug" do
    patch :update, id: @drug, drug: { atc: @drug.atc, drugbank: @drug.drugbank, name: @drug.name, reference: @drug.reference }
    assert_redirected_to drug_path(assigns(:drug))
  end
